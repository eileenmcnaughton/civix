omnipay-<?php echo strtolower($processorName) ?>
...
1. Create a repo called <?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?> on your github account.
...
git remote add origin git@github.com:<?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?>.git
...
```
    "repositories": [
           {
               "type": "git",
               "url":  "https://github.com/<?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?>.git"
           },
```
...
```  
      "require":
      {
          "<?php echo $vendor ?>/omnipay-<?php echo strtolower($processorName) ?>": "dev-master"
      },
```
...
``
composer update <?php echo $vendor ?>/omnipay-<?php echo strtolower($processorName) ?> --prefer-dist
``
...
[![Build Status](https://travis-ci.org/<?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?>.png?branch=master)](https://travis-ci.org/<?php echo strtolower($githubUserName) ?>/omnipay-<?php echo strtolower($processorName) ?>)
[![Latest Stable Version](https://poser.pugx.org/<?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?>/version.png)](https://packagist.org/eileenmcnaughton/omnipay-<?php echo strtolower($processorName) ?>)
[![Total Downloads](https://poser.pugx.org/eileenmcnaughton/<?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?>/d/total.png)](https://packagist.org/eileenmcnaughton/<?php echo $githubUserName ?>/omnipay-<?php echo strtolower($processorName) ?>)

## Basic Usage

The following gateways are provided by this package:

* <?php echo $processorName . (!empty($suffix) ? '_' . $suffix : '') ?>
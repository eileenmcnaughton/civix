...
return array(
    array(
      'name' => 'OmniPay - <?php echo $processorName ?>',
      'entity' => 'payment_processor_type',
      'params' =>
        array(
          'version' => 3,
          'title' => 'OmniPay - <?php echo $processorName  . (!empty($suffix) ? ' ' . $suffix : '')?>',
          'name' => 'omnipay_<?php echo $processorName . (!empty($suffix) ? '_' . $suffix : '') ?>',
          'description' => 'Omnipay <?php echo $processorName ?> Payment Processor',
          'user_name_label' => '<?php echo $credential1 ?>',
          'password_label' => '<?php echo $credential2 ?>',
          'signature_label' => '<?php echo $credential3 ?>',
          'site_url' => '',
          'class_name' => 'Payment_OmnipayMultiProcessor',
          'billing_mode' => 1,
          'payment_type' => <?php echo ($isTransparentRedirect ? 3 : 4) ?>,
        ),
<?php if ($isTransparentRedirect) { echo
"        'transparent_redirect' => array(
          'fields' => array(
            // These fields are displayed on the transparent redirect form. Alter as appropriate.
            'data'  => array('type' => 'function', 'value' => 'getData', 'htmlType' => 'hidden',),
            'InterfaceVersion' => array('type' => 'fixed', 'value' => 'HP_2.9', 'htmlType' => 'hidden'),
            'Seal' => array('type' => 'fixed', 'value' => 'getData', 'htmlType' => 'hidden'),
          ),
        ),\n";
} ?>
    ),

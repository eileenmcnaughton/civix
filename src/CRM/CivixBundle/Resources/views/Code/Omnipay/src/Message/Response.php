 ...
 * Response
 */
class <?php echo $suffix ?>Response extends AbstractResponse implements RedirectResponseInterface
{
  /**
   ...
   * @var string
   */
    public $endpoint = '<?php echo (!empty($siteUrl) ? $siteUrl : (!empty($testUrl) ? $testUrl : '')) ?>';
    ...
    {
        return <?php echo ($isTransparentRedirect ? 'true' :'false') ?>;
    }
